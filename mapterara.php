...
<html lang="en">
    ...
    <body>
        ...
        <div class="visible-lg visible-md">
            ...
            <div id="sidemenu" class="well">
                ...
                <?php  
                    ...
                    ?>
                    <a href="mapterara.php"class="list-group-item point-item"> <h4 class="list-group-item-heading" ><?php echo $data['nama']; ?></h4>
        ...
        <script>
            function map_init() {
                var mapOptions = {
                    center : new google.maps.LatLng(-8.678687, 116.430022),
                    zoom : 15,
